...
public class PlayerState extends Event {
    ...
    public PlayerState(int lives, int state, int maxBombs, int bombRange,
            int x, int y) {
        this.lives = lives;
        this.state = state;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.getClass().equals(obj.getClass())) {
            ...
            return (this.state == that.state)
                    && (this.bombRange == that.bombRange)
                    && (this.maxBombs == that.maxBombs)
                    && (this.lives == that.lives) && (this.x == that.x)
                    && (this.y == that.y);
