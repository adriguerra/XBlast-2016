...
public class EventsGenerator {
    ...
    private void checkAllPlayersEqualNumEvents(EventSequence[] playersEvents) {
        ...
        for (EventSequence pEvents : playersEvents) {
            if (pEvents.getNumEvents() != eventsNum) {
                ...
                throw new IllegalArgumentException("Epected " + eventsNum
                        + " but found " + pEvents.getNumEvents()
    ...
    private Map<PlayerID, Iterator<Event>> createIterators(
            EventSequence[] playersEvents) {
        ...
        for (EventSequence playerEvents : playersEvents) {
            ...
            iterators.put(playerEvents.getPlayerID(),
                    playerEvents.getEventIterator());
